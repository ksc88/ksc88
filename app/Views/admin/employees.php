...
<body>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="data-tables datatable-dark text-center">
                                    <a href="<?= base_url() ?>/addEmp" class="btn btn-sm btn-info">Add New Employee</a>
                                    <table id="dataTable3" class="table table-hover table-striped text-center">
                                        ...
                                        <tbody><?php $count = 1;  foreach ($employee as $emp) :?>
                                      ...
                                      <tr>      
                                                    ...
                                                    <td><?= esc($emp['doj']) ?></td>
                                                    <td>
                                                  <?php  if($emp['status']){ ?>  <span class="badge badge-pill badge-success">Active</span> <?php } else { ?>
                                                   <span class="badge badge-pill badge-danger">Inactive</span> <?php } ?>
                                                  </td>
                                                    <td><a href="#"><i class="fa fa-edit" style="color:green"></i></a>
                                                    <?php if( $emp['status']==1) {?>
                                                    <a href="<?php echo base_url()?>/updateEmpStatus/<?php echo $emp['per_no'];?>/<?php echo $sts=0;?> " onclick="return confirm('Are you sure you want to inactive this employee?');"><i class="fa fa-times-circle" style="color:red"></i></a> <?php } else {?>
                                                 <a href="<?php echo base_url()?>/updateEmpStatus/<?php echo $emp['per_no'];?>/<?php echo $sts=1;?>" onclick="return confirm('Are you sure you want to Activate this employee?');"><i class="fa fa-check" style="color:green"></i></a> <?php } ?>
                                                </td>    
    ...
    <script src="<?php echo base_URL(); ?>/public/assets/js/line-chart.js"></script>
    <!-- all pie chart -->
    <script src="<?php echo base_URL(); ?>/public/assets/js/pie-chart.js"></script>
