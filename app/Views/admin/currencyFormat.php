...
class currencyFormat {
	 ...
	 *                                                        convert
	 *
	 * @throws     Exception\currencyFormatInvalidNumber   When passed variable is not numeric
	 * @throws     Exception\currencyFormatNumberOverflow  When passed number is greater than system maximum
	 *
	...
	public function numToWord( $number ) {
		...
		if ( ! is_numeric( $number ) ) {
			throw new Exception\currencyFormatInvalidNumber( 'Valid number not given.' );
		}

		// Check if number is exceeding the system maximum
		if ( $number > PHP_INT_MAX ) {
			throw new Exception\currencyFormatNumberOverflow( 'Number is greater than system maximum.' );
		}
	...
	public function numToWordSmall( $number ) {
		...
		if ( $number > 99 ) {
			throw new Exception\currencyFormatNumberOverflow( 'Number is greater than 99. Use numToWord method.' );
		}
