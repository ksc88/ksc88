                    ...
                    <div class="col-6 col-ml-12">
                        <div class="row">
                            ...
                            <div class="col-6 mt-5">
                                ...
                                <div class="card">
                                    <form action="<?php echo base_URL('updateContract/'. $data['id']) ?>" method="post">
                                        <?= csrf_field() ?>
                                        ...
                                        <div class="row">   
                                            <div class="col-md-6 form-group">
                                                ...
                                                <option value="">Choose..</option>
                                                        ...
                                                        <option value="<?= $row['customer_id']?>"<?php  if($data['customer_id'] ==$row['customer_id']) {echo "selected"; } ?>><?php echo $row['customer_id'].'-'.$row['customer_name']?></option>
                                                    <?php endforeach ?>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input class="form-control" type="text" name="contract_number" id="contract_number" value="<?= $data['contract_number'];?>" required>
                                            </div>
                                            
                                            <div class=" col-md-6 form-group">
                                                <label for="example-date-input" class="col-form-label">Contract Date</label>
                                                <input class="form-control" type="date" name="contract_date" id="contract_date" value="<?= $data['contract_date'];?>" >
                                            </div>
                                            ...
                                            <div class=" col-md-6 form-group">
                                                ...
                                                <select class="custom-select" name="fy" autocomplete="off" required>
                                                    <option value="">Choose..</option>
                                                    <option value="21-22" <?php if($data['fy'] =='21-22') {echo "selected"; } ?>>21-22</option>
                                                    <option value="22-23" <?php if($data['fy'] =='22-23') {echo "selected"; } ?>>22-23</option>
                                                    <option value="23-24" <?php if($data['fy'] =='23-24') {echo "selected"; } ?>>23-24</option>
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input class="form-control" type="text" name="contract_value" id="contract_value"  value="<?= $data['contract_value'];?>" required>
                                            </div>                                        
                                        
                                            <div class="col-md-6 form-group">
                                                <label for="example-date-input" class="col-form-label">GST Value</label>
                                                <input class="form-control" type="text" name="gst_value" id="gst_value"  value="<?= $data['gst_value'];?>" required>
