                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Edit Customer Details</h4>
                ...
                <div class="container">
                    <div class="row">
                            ...
                            <div class="col-6 mt-5">
                                ...
                                <div class="card">
                                    <form action="<?=base_URL('updateCustomer/'.($data->id)) ?>" method="post">
                                        <?= csrf_field() ?>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input class="form-control" name="customer_id" type="text" autocomplete="off" id="customer_id" value="<?= esc($data->customer_id)?>" required >
                                            </div>

                                            <div class="col-md-6 form-group">
                                                <label for="example-text-input" class="col-form-label">Customer Name</label>
                                                <input type="text" class="form-control" autocomplete="off" id="customer_name" name="customer_name" value="<?= esc($data->customer_name)?>" required>
                                            </div>
                                   
                                            <div class="col-md-6 form-group">
                                                <label for="example-date-input" class="col-form-label">Address</label>
                                                <textarea class="form-control"  rows="4" cols="5" name="address" id="address" value="<?= esc($data->address)?>" required><?= esc($data->address)?></textarea>
                                            </div>

                                            <div class="col-md-6 form-group">
                                                <label for="example-date-input" class="col-form-label">email</label>
                                                <input class="form-control" type="text" name="email" id="email" value="<?= esc($data->email)?>">
                                            </div>

                                            <div class="col-md-6 form-group">
                                                <label for="example-date-input" class="col-form-label">Contact</label>
                                                <input class="form-control" type="text" name="contact" id="contact" value="<?= esc($data->contact)?>">
                                            </div>                                        
                                            <div class="col-md-6 form-group">
                                                <label for="example-date-input" class="col-form-label">Payment Auth.</label>
                                                <input class="form-control" type="text" name="payauth" id="payauth" value="<?= esc($data->payauth)?>" required>
