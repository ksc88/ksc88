                                        ...
                                        <form action="<?php echo base_URL() ?>/create" method="post">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="per_no" type="number" autocomplete="off" required id="per_no" onBlur="checkAvailabilityEmpid()">
                                                </div>


                                                <div class="form-group">
                                                    <label for="example-text-input" class="col-form-label">First Name</label>
                                                    <input type="text" class="form-control" autocomplete="off" id="fname" name="first_name" placeholder="Enter First Name">
                                                </div>

                                                <div class="form-group">
                                                    <label for="example-text-input" class="col-form-label">Middle Name</label>
                                                    <input class="form-control" name="middle_name" type="text" autocomplete="off" required id="example-text-input">
                                                </div>
                                                <div class="form-group">
                                                    <label for="example-text-input" class="col-form-label">Last Name</label>
                                                    <input class="form-control" name="last_name" type="text" autocomplete="off" required id="example-text-input">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="contact" type="tel" maxlength="10" autocomplete="off" required>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="bank_account" type="text" autocomplete="off" required>
                                                </div>

                                                <div class="form-group">
                                                    <label for="example-text-input" class="col-form-label">Bank Name </label>
                                                    <input class="form-control" name="bank_name" type="text" autocomplete="off" required>
                                                </div>

                                                <div class="form-group">
                                                    <label for="example-text-input" class="col-form-label">Bank IFSC Code </label>
                                                    <input class="form-control" name="bank_ifsc" type="text" autocomplete="off" required>
                                                </div>

                                                <div class="form-group">
                                                    <label for="example-text-input" class="col-form-label">Gpf/NPS No </label>
                                                    <input class="form-control" name="gpfno" type="text" autocomplete="off" required>
                                                </div>
