...
<?= $this->section('title') ?> TCL | Edit Employee <?= $this->endSection() ?>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="header-title">
            ...
            <small>Employee Edit Page</small>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?= form_open('admin/adminsection/update/'.$data->id ) ?>
                    <?= $this->include('AdminSection/Employee/form/employeeForm'); ?>
                    <div class="col-sm-4  align-middle">
            <button class="btn btn-primary  " name="update" id="add" type="submit"
                onclick="return valid();">Update</button>
                </div>
                    </form>
                    </div>
                </div>
